...
/* Translated by @heenji */
	...
	$lang['error_on_uploading'] 	= "上传时发生了一个错误";
	$lang['message_prompt_delete_file'] 	= "是否确认删除这个文件?";

	$lang['error_max_number_of_files'] 	= "你每次只能上传一个文件。";
	$lang['error_accept_file_types'] 	= "你不允许上传这类扩展的文件。";

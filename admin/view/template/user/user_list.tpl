        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li ><a href="<?php echo $user_chart_action; ?>" data-toggle="tab">用户统计</a></li>
                    ...
                    <div class="tab-pane active" id="bicycle">
                        <form class="search_form" id="search_form" action="<?php echo $action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                ...
                                <select name="city_state" class="input-sm">
                                    <option value="">选择区域</option>
                                    <option value="">东莞</option>
                                    <option value="">深圳</option>
                                    <option value="">广州</option>
                                    <option value="">虎门</option>
                                </select>
                                <input type="text" name="add_time" value="<?php echo $filter['add_time']; ?>" class="input-sm date-range" style="border: 1px solid #a9a9a9;width: 200px;" placeholder="注册时间"/>
                            ...
                            <table class="table table-bordered table-hover dataTable" role="grid">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button data-url="<?php echo $data['edit_action']; ?>" type="button" class="btn btn-primary link" ><i class="fa fa-fw fa-eye-slash"></i>禁用</button>
                                    </td>
                                </tr>
                                <?php } ?>
                                </tbody>

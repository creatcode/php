...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo $static ?>base.css?v=2">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu" id="message-dropdown">
                            ...
                            <div class="message-list">
                                ...
                                <p class="loader-wrapper"><span class="loader">正在加载...</span></p>
                            </div>
        ...
        <section class="sidebar">
            ...
            <div class="header-panel panel-body">
                <a href="<?php echo $home_action; ?>">
                    <i class="fa fa-dashboard" style="color: white;font-size: 28px;padding: 0 5px;/* padding-left: 5px; */position: relative;top: 2px;"></i>&nbsp;<span style="color: white;font-size: 20px;letter-spacing: 5px;">仪表盘</span>
                </a>
            </div>
            <!-- search form -->

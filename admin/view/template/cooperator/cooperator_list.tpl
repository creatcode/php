...
<script type="text/javascript">
    jQuery.getScript('<?php echo HTTP_IMAGE . 'AdminLTE-2.3.7/'; ?>plugins/jquery.treegrid/js/jquery.treegrid.js');
    jQuery.getScript('<?php echo HTTP_IMAGE . 'AdminLTE-2.3.7/'; ?>plugins/jquery.treegrid/js/jquery.treegrid.bootstrap3.js');
    jQuery.getScript('<?php echo HTTP_IMAGE . 'AdminLTE-2.3.7/'; ?>plugins/ztree/jquery.ztree.core.js');
    jQuery.getScript('<?php echo HTTP_IMAGE . 'AdminLTE-2.3.7/'; ?>plugins/ztree/jquery.ztree.excheck.js');
</script>
<script type="text/javascript">

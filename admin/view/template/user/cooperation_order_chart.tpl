        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="javascript:;" data-toggle="tab">合伙人消费统计图表</a></li>
                </ul>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="dataTables_length fa-border clearfix" style="margin: 10px 0; padding: 10px;background: #76767f; color: white;">
                                    <span class="col-sm-5 col-lg-2">总计：<strong><?php echo $orderAmountTotal; ?></strong>元</span>
                                    <span class="col-sm-5">订单数：<strong><?php echo $ordersTotal; ?></strong></span>
                                </div>
                            </div>
                        </div>
                        <div class="row">

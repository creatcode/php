        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li><a href="<?php echo $cooperator_action; ?>">合伙人基本信息</a></li>
                    <li class="active"><a href="javascript:;">操作员管理</a></li>
                    <li><a href="<?php echo $role_action; ?>">操作员角色管理</a></li>
                </ul>
...
<script type="text/javascript" src="<?php echo HTTP_IMAGE . 'AdminLTE-2.3.7/'; ?>plugins/jquery.treegrid/js/jquery.treegrid.js"></script>

                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="coupon_type" value="4" />折扣劵
                                        </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input  type="number" name="number" value="<?php echo $data['number']; ?>" class="form-control" placeholder="请输入数值">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group col-sm-12">
                                            <input <?php if(!$permission){ echo 'disabled="true"'; } ?>  type="number" name="piece" value="<?php echo $data['piece']; ?>" class="form-control" placeholder="请输入数值">
                                            <span class="input-group-addon">张/用户</span>
                                        </div>
                                        <?php if (isset($error['number'])) { ?><div class="text-danger"><?php echo $error['number']; ?></div><?php } ?>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $(function () {
        $('[name="coupon_type"]').on("change", function () {
            ...
            if ($(this).val() == 4) {
                $('[name="number"]').attr('placeholder','请输入折扣(1-9)');
            }else {
                $('[name="number"]').attr('placeholder','请输入数值');
            }
        });
    });

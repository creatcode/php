                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group col-sm-12">
                                            <input type="text" id="input-rent" name="config_bike_rent" value="<?php echo $data['config_bike_rent']; ?>" placeholder="车辆长时未租时间"  class="form-control">
                                            <span class="input-group-addon">小时</span>
                                        </div>
                                         <?php if (isset($error['config_bike_rent'])) { ?>
                                        <div class="text-danger"><?php echo $error['config_bike_rent']; ?></div><?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group col-sm-12">
                                            <input type="text" name="config_bike_return" value="<?php echo $data['config_bike_return']; ?>" placeholder="车辆长时未还时间" id="input-return"  class="form-control">
                                            <span class="input-group-addon">小时</span>
                                        </div>

                    ...
                    <div class="tab-pane active" id="bicycle">
                        <form class="search_form" id="search_form" action="<?php echo $action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                ...
                                <select name="category_id" class="input-sm">
                                    ...
                                    <?php foreach($model['category_id'] as $k => $v) { ?>
                                    <option value="<?php echo $k; ?>" <?php echo (string)$k == $filter['category_id'] ? 'selected' : ''; ?>><?php echo $v; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <form id="table_form" class="table_form" method="post">
                            <table class="table table-bordered table-hover dataTable" role="grid">
                                ...
                                <tr>
                                    <!--<td><input type="checkbox" name="selected[]" value="<?php echo $data['article_id']?>"></td>-->
...
<script type="text/javascript">
    ...
    //因为编辑页面要加载富文本编辑器 所以这里要去掉ajax加载页面的逻辑
    $(function(){
       $("a").unbind();
    });
</script>

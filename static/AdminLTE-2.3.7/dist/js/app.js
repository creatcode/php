    ...
    fix: function () {
      ...
      if ($("body").hasClass("fixed")) {
        ...
        if (window_height >= sidebar_height) {
          ...
          var t1=$('.content-wrapper').children('.content-header');
          var t2=$('.content-wrapper').children('.content');

          if(t1!=undefined&&t1!=null&&t2!=undefined&&t2!=null){
            var h1=t1.height()+t2.height();
            if(h1>window_height - neg){
              $(".content-wrapper, .right-side").css('min-height', h1+50);
              $(".content-wrapper, .right-side").css('height', h1+50);
            }else{

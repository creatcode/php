...
<section class="content">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="javascript:;" data-toggle="tab">充值记录列表</a></li>
                    ...
                    <div class="tab-pane active" id="bicycle">
                        <form class="search_form" id="search_form" action="<?php echo $action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                ...
                                <input type="text" name="pdr_add_time" value="<?php echo $filter['pdr_add_time']; ?>" class="input-sm date-range" style="border: 1px solid #a9a9a9;width: 200px;" placeholder="注册时间"/>
                        ...
                        <form id="table_form" class="table_form" method="post">
                            <table class="table table-bordered table-hover dataTable" role="grid">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['pdr_add_time']?></td>

        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class=""><a href="<?php echo $version_ios_action; ?>" data-toggle="tab">IOS</a></li>
                    ...
                    <li <?php if ($type==3) { ?>class="active"<?php } ?>><a href="<?php if ($type==3) { ?>javascript:;<?php } else { echo $version_android_action . '&type=3'; } ?>" data-toggle="tab">运维版本（安卓）</a></li>
                </ul>

...
require_once(DIR_SYSTEM . 'helper/tools.php');
require_once(DIR_SYSTEM . 'helper/rsa.php');
require_once(DIR_SYSTEM . 'helper/md5.php');
require_once(DIR_SYSTEM . 'helper/constant.php');

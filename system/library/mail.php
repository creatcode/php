...
class Mail {
	 ...
	 * @param $parameter
	 */
	public function setMailParameter($parameter) {
	...
	/**
	 * 设置smtp类型邮件的发送超时时间,默认5秒,不能用在win32
	 * @param int $smtp_timeout
	 */
	public function setSmtpTimeout($smtp_timeout) {
		$this->smtp_timeout = $smtp_timeout;
	}

	/**
	 * 设置smtp类型邮件的 verp，默认是false
	 * @param bool $verp
	 */

        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="javascript:;" data-toggle="tab">财务月报表</a></li>
                    ...
                    <div class="tab-pane active" id="bicycle">
                        <form class="search_form" id="search_form" action="<?php echo $action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                <input type="text" name="search_time" value="<?php echo $filter['search_time']; ?>" class="input-sm date-month" style="border: 1px solid #a9a9a9;" placeholder="时间范围"/>
                        ...
                        <form id="table_form" class="table_form" method="post">
                            <table class="table table-bordered table-hover dataTable finance-table" role="grid">
                                <thead>
                                    <tr>
                                        <th width="20%">项目</th>
...
<!-- /.content -->
<style type="text/css">
    .finance-table tr:nth-child(2) td:nth-child(1){color: #a5a5a5; text-indent: 1em;}

                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="bicycle">
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo $action; ?>">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">区域编号</label>
                                <div class="col-sm-8">
                                    <input type="text" name="region_city_ranking" value="<?php echo $data['region_city_ranking']; ?>" class="form-control" disabled="disabled">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">消费上限</label>
                                <div class="col-sm-8">
                                    <input type="text" name="upper_expend" value="<?php echo $data['upper_expend']; ?>" class="form-control">
                                    <?php if (isset($error['upper_expend'])) { ?><div class="text-danger"><?php echo $error['upper_expend']; ?></div><?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">停放点设置</label>
                                <div class="col-sm-8">
                                    <div class="col-sm-12 row form-group">
                                        <button type="button" class="btn btn-large btn-primary margin-r-5 button-add-park">添加点</button>
                                        <!--<button type="button" class="btn btn-large btn-danger  button-clear-park">
                                            点<input type="hidden" name="park[]" value="">
                                        </button>-->
                                    </div>

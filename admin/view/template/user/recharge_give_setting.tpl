        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li ><a href="<?php echo $user_rating_action ?>" data-toggle="tab">充值优惠列表</a></li>
                    <li ><a href="<?php echo $deposit_recharge_chart_action; ?>" data-toggle="tab">充值优惠统计</a></li>
                    <li class="active"><a href="javascript:;" data-toggle="tab">充值优惠设置</a></li>
                </ul>
                    ...
                    <div class="tab-pane active form-group">
                        <form class="search_form" id="search_form" action="<?php echo $action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                ...
                                <select name="pre_type"  id="pre_type"   class="input-sm">
                                     <option value>状态</option>
                                    <?php foreach($pre_type as $k => $v) { ?>
                                    <option value="<?php echo $k; ?>" <?php echo (string)$k == $filter['pre_type'] ? 'selected' : ''; ?>><?php echo $v; ?></option>
                                    <?php } ?>
                            ...
                            <form id="table_form" class="table_form" method="post">
                                <table class="table table-bordered table-hover dataTable" role="grid">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $data['recharge_amount']?></td>
                                        <td><?php echo $data['present_amount']?></td>
                                        <td><?php echo $pre_type[$data['state']]?></td>

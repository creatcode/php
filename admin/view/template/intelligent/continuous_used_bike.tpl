        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="javascript:;" data-toggle="tab">用户长期连续使用同一单车</a></li>
                </ul>
                        ...
                        <form class="search_form" id="search_form" action="<?php echo $action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                <select class="input-sm" name="used_num">
                                    ...
                                    <option <?php echo $filter['used_num']=='5'?'selected':'' ?>  value="5">大于5</option>
                                    <option <?php echo $filter['used_num']=='8'?'selected':'' ?>  value="8">大于8</option>
                                </select>
                        ...
                        <form id="table_form" class="table_form" method="post">
                            <table class="table table-bordered table-hover dataTable" role="grid">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button data-url="<?php echo $info_url.'&user_id='.$data['user_id'].'&bicycle_sn='.$data['bicycle_sn'] ?>" type="button" class="btn btn-info link"><i class="fa fa-fw fa-eye"></i>查看</button>
                                    </td>
                                </tr>
                                <?php } ?>
                                </tbody>

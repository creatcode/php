        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="<?php echo $account_action; ?>">操作员管理</a></li>
                    <li class="active"><a href="javascript:;">操作员角色管理</a></li>
                </ul>
                        ...
                        <form id="table_form" class="table_form" method="post">
                            <table class="table table-bordered table-hover dataTable" role="grid">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button data-url="<?php echo $data['edit_action']; ?>" type="button" class="btn btn-info btn-sm link"><i class="fa fa-fw fa-edit"></i>编辑</button>

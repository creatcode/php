        ...
        <div id="map-n-statistics" class="no-padding">
            ...
            <div id="map-toolbar">
                ...
                <div class="checkbox hidden-xs hidden-sm hidden-md" style="margin-left: 3px;">
                    <label>
                        <input type="checkbox" id="show-heatmap"> <span class="">显示热力图</span>
                    </label>
                </div>
                |
                ...
                <div class="dropdown show-bike-select" style="margin-right: 0;">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownOfShowBikes">
                        ...
                        <li role="separator" class="divider"></li>
                        <li data-bike_type="bikeHide"><a href="#">隐藏的单车</a></li>
                    </ul>
                </div>
                <form method="post" action="<?php echo $export_action; ?>" style="font-size: 14px; vertical-align: baseline;display: inline-block;">
                    ...
                    <button class="btn btn-default btn-xs btn-no-border hidden-phone hidden-xs hidden-sm hidden-md" style="font-size: 14px; vertical-align: baseline;">
                        <i class="fa fa-file-excel-o"></i> <span class="">导出Excel</span>
                    </button>
                </form>
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="statistics-block tow-lines-block" style="line-height: 15px;">
                                今日收入：￥<?php echo $recharge_sum['orderToday']?$recharge_sum['orderToday']:'0.00' ?><br/>
                                总金额：￥<?php echo $recharge_sum['orderTotal']?$recharge_sum['orderTotal']:'0.00' ?><br/>
                                今日余额充值：￥<?php echo $recharge_sum['rechargeToday']?$recharge_sum['rechargeToday']:'0.00' ?><br/>
                                余额充值总额：￥<?php echo $recharge_sum['rechargeTotal']?$recharge_sum['rechargeTotal']:'0.00' ?>
                            </div>
                        </li>
                        <li>
                            <div class="statistics-block-title">押金</div>
                            <div class="statistics-block three-lines-block" style="line-height: 15px;">
                                今日内交：￥<?php echo $deposit_sum['rechargeToday']?$deposit_sum['rechargeToday']:'0.00' ?><br/>
                                总金额：￥<?php echo $deposit_sum['rechargeTotal']?$deposit_sum['rechargeTotal']:'0.00' ?><br/>
                                今日退押金：￥<?php echo $deposit_sum['refundToday']?$deposit_sum['refundToday']:'0.00' ?><br/>
                                退押金总额：￥<?php echo $deposit_sum['refundTotal']?$deposit_sum['refundTotal']:'0.00' ?>
                            </div>
                        </li>
                        <li>
                            <div class="statistics-block-title">用车券</div>
                            <div class="statistics-block tow-lines-block" style="line-height: 15px;">
                                今日已使用：<?php echo $coupon_sum['countUsedToday']?$coupon_sum['countUsedToday']:'0' ?>张<br/>
                                全部已使用：<?php echo $coupon_sum['countUsedTotal']?$coupon_sum['countUsedTotal']:'0' ?>张<br/>
                                今日已发放：<?php echo $coupon_sum['countAddToday']?$coupon_sum['countAddToday']:'0' ?>张<br/>
                                全部已发放：<?php echo $coupon_sum['countAddTotal']?$coupon_sum['countAddTotal']:'0' ?>张
                            </div>
                        </li>
                    </ul>
                </div>

<?php
//HTTP
define('HTTP_SERVER', '<URLBASE>/blt_lock');
define('HTTP_CATALOG', '<URLBASE>/static/');
define('HTTP_IMAGE', HTTP_CATALOG);

//DIR
define('DIR_BASE', dirname(dirname(__FILE__)));
define('DIR_APPLICATION', DIR_BASE . '/blt_lock/');
define('DIR_SYSTEM', DIR_BASE . '/system/');
define('DIR_STATIC', DIR_BASE . '/static/');
define('DIR_TEMPLATE', DIR_BASE . '/blt_lock/view/template/');
define('DIR_LANGUAGE', DIR_BASE . '/blt_lock/language/');
...
define('OFFLINE_THRESHOLD', 3610); //后台认为单车短时间失联（离线）的判断标准（单位秒）

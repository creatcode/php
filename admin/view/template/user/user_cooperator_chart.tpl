        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="<?php echo $cooperator_chart_action; ?>" data-toggle="tab">合伙人用户统计</a></li>
                        ...
                        <form class="search_form" id="search_form" action="<?php echo $add_action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                ...
                                <select name="cooperator_id" style="height: 30px; margin-left: 8px; width:160px; ">
                                    ...
                                    <?php if($cooperator_id == 0 && $cooperator_id !=''){ ?>
                                    <option selected="selected" value="0">平台</option>
                                    <?php }else{ ?>

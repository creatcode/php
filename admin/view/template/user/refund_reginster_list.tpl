        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="javascript:;" data-toggle="tab">注册金退款申请列表</a></li>
                </ul>
                        ...
                        <form id="table_form" class="table_form" method="post">
                            <table class="table table-bordered table-hover dataTable" role="grid">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $data['apply_add_time']?></td>
                                    <td><?php echo $data['apply_audit_admin_name']?></td>
                                    <td><?php echo $data['apply_audit_result']?></td>
                                    <td class="text-center"><?php echo $data['apply_audit_time']?></td>
                                    <td>

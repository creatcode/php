                        ...
                        <form id="table_form" class="table_form" method="post">
                            <table class="table table-bordered table-hover dataTable tree" role="grid">
                                ...
                                <tr class="treegrid-<?php  echo $tree_index++; ?>  " >
                                    ...
                                    <td>
                                        <?php echo $data['region_name']?><?php if($data['city_num']){?> <span class="fa fa-plus get-city" data-index="<?php echo $tree_index-1; ?>" data-region="<?php echo $data['region_id']; ?>"></span><?php }?>
                                    </td>
                                    <td></td>
                                    <td></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button data-url="<?php echo $data['edit_action']; ?>" type="button" class="btn btn-info link"><i class="fa fa-fw fa-pencil"></i><?php echo @$lang['t8'];?></button>
                                            <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
                                                <span class="caret"></span>
                                                <span class="sr-only">Toggle Dropdown</span>
                                            </button>
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="<?php echo $data['delete_action']; ?>"><?php echo @$lang['t6'];?></a></li>
                                                <li><a href="<?php echo $yunyin_action; ?>"><?php echo @$lang['t7'];?></a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
                ...
                if(data.length){
                    for(var i = 0;i < data.length;i++ ){
                        $(that).parent().parent().after("<tr class=\"treegrid-"+global_tree_index+" treegrid-parent-"+tree_index+"\">" +
                            ...
                            "<td>"+data[i]["city_name"]+"<!--<span class=\"fa fa-plus get-station\" data-index=\""+global_tree_index+"\" data-city=\""+data[i]["city_id"]+"\"></span>--></td>" +//先不显示站点
                            "<td></td>" +
                            "<td></td>" +

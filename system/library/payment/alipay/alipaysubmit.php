...
class alipaySubmit {
    ...
    function AlipaySubmit($alipay_config = array()) {
	...
	public function buildRequestPara($para_temp) {
		...
		//生成签名结果
		$my_sign = $this->buildRequestMySign($para_sort);
		
		//签名结果与签名方式加入请求提交参数组中
		$para_sort['sign'] = $my_sign;
	...
	public function buildRequestParaToString($para_temp) {
		...
		$request_data = aliPayTool::createLinkStringUrlEncode($para);

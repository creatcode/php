        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li ><a href="<?php echo $user_list_action; ?>" data-toggle="tab"><?php echo @$lang['t3'];?></a></li>
                    <li class="active"><a href="<?php echo $user_chart_action; ?>" data-toggle="tab"><?php echo @$lang['t4'];?></a></li>
                    ...
                    <div class="tab-pane active">
                        <form class="search_form" id="search_form" action="<?php echo $user_chart_action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                ...
                                <input type="text" name="add_time" value="<?php echo $filter['add_time']; ?>" class="input-sm date-range" style="border: 1px solid #a9a9a9;width: 300px;" placeholder=""/>
                        ...
                        <div class="clearfix">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="box box-danger">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><?php echo @$lang['t15'];?></h3>
                            ...
                            <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="box box-danger">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><?php echo @$lang['t16'];?></h3>
                            ...
                            <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="box box-danger">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><?php echo @$lang['t17'];?></h3>

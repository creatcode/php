            ...
            <div class="nav-tabs-custom">
                ...
                <form class="search_form" action="<?php echo $return_action; ?>" method="get">
                    ...
                    <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                        ...
                        <div class="pull-right">
                            <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-search"></i>&nbsp;<?php echo @$lang['t5'];?></button>
                        </div>
                    </div>
                </form>
                ...
                <div class="tab-content">
                    <div class="form-group">
                        <a href="<?php echo $add_action; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;<?php echo @$lang['t6'];?></a>
                    </div>
                        ...
                        <form id="table_form" class="table_form" method="post">
                            <table class="table table-bordered table-hover dataTable" role="grid">
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <th style="min-width:130px;"><?php echo @$lang['t7'];?></th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['adv_city_id']?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button data-url="<?php echo $data['edit_action']; ?>" type="button" class="btn btn-info link"><i class="fa fa-fw fa-pencil"></i><?php echo @$lang['t22'];?></button>
                                            <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
                                                <span class="caret"></span>
                                                <span class="sr-only">Toggle Dropdown</span>
                                            </button>
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="<?php echo $data['delete_action']; ?>"><?php echo @$lang['t8'];?></a></li>
                                            </ul>
                                        </div>
                                        <div class="btn-group">
                                            <button data-aid="<?php echo $data['adv_id']?>"  type="button" class="btn btn-info sendClass"><?php echo @$lang['t9'];?></button>
                                        </div>
                                        <div class="btn-group">
                                            <button data-aid="<?php echo $data['adv_id']?>"  type="button" class="btn btn-info ckeckClass"><?php echo @$lang['t10'];?></button>
                                        </div>
                                    </td>
                                </tr>
                                <?php } ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-blue-gradient" style="padding:10px">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><?php echo @$lang['t11'];?></h4>
                </div>
                <div class="modal-body">
                    <form method="post" action="<?php echo $batch_handling_action; ?>">
                        <div class="box-body">
                            <div class="form-group col-sm-12">
                                <label for="" class="col-sm-2 control-label" style="width:12%"><?php echo @$lang['t12'];?></label>
                                <div class="col-sm-10">
                                    <span class="adv_approve_memo adv_add_memo"> </span>
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                <label for="" class="col-sm-2 control-label" style="width:12%"><?php echo @$lang['t13'];?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group col-sm-12 repair_type">
                                <label for="" class="col-sm-3 control-label" style="width:12%"><?php echo @$lang['t14'];?></label>
                                <div class="col-sm-9">
                                    <label class="radio-inline pull-left">
                                        <input type="radio" name="adv_approved" class="adv_approved" value="1" /><?php echo @$lang['t15'];?>
                                    </label>
                                    <label class="radio-inline pull-left">
                                        <input type="radio" name="adv_approved" value="2" /><?php echo @$lang['t16'];?>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group col-sm-12 handle_content">
                                <label for="" class="col-sm-2 control-label" style="width:12%"><?php echo @$lang['t17'];?></label>
                                <div class="col-sm-10">
                                    <span><textarea class="col-sm-10" rows="3" name="adv_approve_memo" placeholder="<?php echo @$lang['t18'];?>"></textarea></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="pull-right">
                                        ...
                                        <a href="javascript:;" class="btn btn-sm btn-primary batchHandlingSubmit"><?php echo @$lang['t19'];?></a>
                                        <a href="javascript:;" class="btn btn-sm btn-default" data-dismiss="modal"><?php echo @$lang['t20'];?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-blue-gradient" style="padding:10px">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><?php echo @$lang['t21'];?></h4>
                </div>
                <div class="modal-body">

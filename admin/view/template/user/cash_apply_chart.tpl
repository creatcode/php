        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="javascript:;" data-toggle="tab"><?php echo @$lang['t47'];?></a></li>
                    ...
                    <div class="tab-pane active">
                        <form class="search_form" id="search_form" action="<?php echo $action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px;">
                                ...
                                <input type="text" name="add_time" value="<?php echo $filter['add_time']; ?>" class="input-sm date-range" style="border: 1px solid #a9a9a9;width: 300px;" placeholder="<?php echo @$lang['t51'];?>"/>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="dataTables_length fa-border clearfix" style="margin: 10px 0; padding: 10px;background: #76767f; color: white;">
                                    <span class="col-sm-5 col-lg-2"><?php echo @$lang['t37'];?>：<strong><?php echo $depositTotal; ?></strong><?php echo @$lang['t41'];?></span>
                                    <span class="col-sm-5"><?php echo @$lang['t38'];?>：<strong><?php echo $balanceTotal; ?></strong><?php echo @$lang['t41'];?></span>

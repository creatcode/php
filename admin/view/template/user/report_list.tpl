        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="javascript:;" data-toggle="tab"><?php echo @$lang['t2'];?></a></li>
                    <!-- <li><a href="<?php echo $day_report_action; ?>" data-toggle="tab">财务日报表</a></li> -->
                    <li><a href="<?php echo $summary_report_action; ?>" data-toggle="tab"><?php echo @$lang['t36'];?></a></li>
                </ul>

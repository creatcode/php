        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="<?php echo $region_chart_action; ?>" data-toggle="tab"><?php echo @$lang['t5'];?></a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active">
                        <form class="search_form" id="search_form" action="<?php echo $add_action; ?>" method="get">
                            <!-- 搜索 -->
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                ...
                                <select name="region_id" style="height: 30px; margin-left: 8px; width:160px; ">
                                    ...
                                    <?php if($region_id == 0 && $region_id !=''){ ?>
                                    <option selected="selected" value="0"><?php echo @$lang['t18'];?></option>
                                    <?php }else{ ?>
                                    <option value="0"><?php echo @$lang['t18'];?></option>
                                    <?php } ?>
                            ...
                            <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="box box-danger">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><?php echo @$lang['t19'];?></h3>
